...
import com.example.sgoel01.bluemusic.AudioData;
import com.example.sgoel01.bluemusic.FFTData;
...
public class LineRenderer extends Renderer
{
    ...
    public void onRender(Canvas canvas, AudioData data, Rect rect)
    {
        ...
        for (int i = 0; i < data.bytes.length - 1; i++) {
            ...
            //Log.d("Datamusic", "The mpoints are: " + Float.toString(data.bytes[i]));
        }
        ...
        //Log.d("amplitude", "Amplitude is: " + Float.toString(amplitude));
    }
